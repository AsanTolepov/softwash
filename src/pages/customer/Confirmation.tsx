    ...
    <Card className="animate-fade-in text-center">
      <CardHeader className="pb-4">
        ...
        <p className="text-muted-foreground">
          Sizning kir yuvish buyurtmangiz qabul qilindi
        </p>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3 text-left p-4 bg-card border rounded-lg">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              ...
              <span>
                Operatorimiz buyurtmangizni ko‘rib chiqadi va
                taxminiy narxni hisoblaydi.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-5 h-5 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 text-xs font-medium mt-0.5">
              ...
              <span>
                Siz bilan bog‘lanib, yakuniy narx va tafsilotlarni
                tasdiqlaymiz.
              </span>
            </li>
            <li className="flex items-start gap-2">
              ...
              <span>
                Buyumlaringiz belgilangan sanada tayyor bo‘ladi.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 text-muted-foreground">
          ...
          <span className="text-sm">
            Savollaringiz bormi? Bizga +998 (88) 562-21-06 yoki +998
            (93) 489-11-17 raqamiga qo‘ng‘iroq qiling.
          </span>
        </div>

        <Button asChild variant="outline" className="w-full">
          {/* AVVAL to="/new-order" edi, endi root-ga qaytadi */}
          <Link to="/">
