...
export default function Employees() {
  ...
  const getShiftLabel = (shift: string): string => {
    switch (shift) {
      ...
      case 'Kechki':        // eski DB yozuvlari uchun backward compat
      case 'Yarim stavka':
  ...
  const openEditDialog = (emp: EmployeeType) => {
    ...
    setEditForm({
      ...
      role:
        ...
        '',
      phone: emp.phone,
      // Eski 'Kechki' qiymatini yangi 'Yarim stavka' ga normalize qilamiz
      shift: emp.shift === 'Kechki' ? 'Yarim stavka' : emp.shift,
