        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            >
              ...
              <div className="space-y-2">
                <Label>{t('expensesPage.form.category')}</Label>
                <Select
                  value={form.category}
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="ijara">
                      {t('expensesPage.categories.ijara')}
                    </SelectItem>
                    <SelectItem value="kommunal">
                      {t('expensesPage.categories.kommunal')}
                    </SelectItem>
                    <SelectItem value="jihozlar">
                      {t('expensesPage.categories.jihozlar')}
                    </SelectItem>
                    <SelectItem value="oylik">
                      {t('expensesPage.categories.oylik')}
                    </SelectItem>
                    <SelectItem value="boshqa">
                      {t('expensesPage.categories.boshqa')}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
                ...
                <TableRow key={e.id}>
                  ...
                  <TableCell>
                    <span className="text-xs px-2 py-0.5 rounded-full bg-muted text-muted-foreground">
                      {e.category
                        ? (t(`expensesPage.categories.${e.category}` as any) || e.category)
                        : t('expensesPage.categories.boshqa')}
                    </span>
                  </TableCell>
                  <TableCell>
