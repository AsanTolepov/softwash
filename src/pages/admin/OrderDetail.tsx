...
export default function OrderDetail() {
  ...
  const [total, setTotal] = useState(
    order?.payment.total.toString() || '0',
  );
  const [advance, setAdvance] = useState(
    order?.payment.advance.toString() || '0',
  );
        ...
        <CardContent>
          ...
          {!canManageOrders && (
            <p className="mt-3 text-xs text-muted-foreground">
              Eslatma: Sizda buyurtma holatini
              o‘zgartirish huquqi yo‘q, faqat
              ko‘rishingiz mumkin.
            </p>
          )}
        </CardContent>
          ...
          <CardContent className="space-y-3">
            ...
            {!canManageOrders && (
              <p className="text-xs text-muted-foreground">
                Sizda to‘lov summasini o‘zgartirish
                huquqi yo‘q.
              </p>
            )}
          </CardContent>
