...
export const ru = {
    ...
    settingsPage: {
      ...
      permissions: {
        ...
        description:
          'Здесь вы можете настроить, какие разделы могут просматривать сотрудники и кто может управлять заказами.',
        descriptionBold: 'управлять заказами',
        notAdmin: 'Управлять правами сотрудников может только администратор компании.',
        noEmployees:
          'Сотрудников пока нет. Сначала добавьте их в разделе «Сотрудники».',
        colEmployee: 'Сотрудник',
        colSections: 'Разделы (просмотр)',
        colActions: 'Действия по заказам',
        ...
        labelManageOrders: 'Управление заказами (статус, оплата, удаление)',
      },
    },
    ...
    expensesPage: {
      ...
      categories: {
        ijara: 'Арендная плата',
        kommunal: 'Коммунальные услуги',
        jihozlar: 'Оборудование / Средства стирки',
        oylik: 'Зарплата сотрудников',
    ...
    reportsPage: {
      ...
      expenseBreakdownTitle: 'Детализация расходов',
      expenseBreakdownCategory: 'Категория',
      expenseBreakdownAmount: 'Сумма',
      expenseBreakdownNoData: 'Данных о расходах пока нет',
      netProfitLabel: 'Чистая прибыль',
      netProfitFormula: 'Доход − Расход',
    },
    settingsOrderSection: {
      title: 'Настройки заказов',
      processingDaysLabel: 'Дней обработки (задержка)',
      processingDaysHint: 'Через сколько рабочих дней после приёма заказа начнётся стирка (по умолчанию: 3)',
      dailyOrderLimitLabel: 'Дневной лимит заказов',
      dailyOrderLimitHint: 'Максимальное количество заказов, принимаемых за один день (по умолчанию: 100)',
    },
  };